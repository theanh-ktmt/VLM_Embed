...
from .configuration_qwen3_vl import Qwen3_VLConfig, Qwen3_VLVisionConfig
...
_CONFIG_FOR_DOC = "Qwen3_VLConfig"


class Qwen3_VLMLP(nn.Module):
...
class Qwen3_VisionRotaryEmbedding(nn.Module):
...
class Qwen3_VLPatchMerger(nn.Module):
...
class Qwen3_VLVisionFlashAttention2(nn.Module):
...
class Qwen3_VLVisionAttention(nn.Module):
    def __init__(self, dim: int, num_heads: int = 16) -> None:
        super().__init__()
        self.num_heads = num_heads
...
class Qwen3_VLVisionSdpaAttention(nn.Module):
    def __init__(self, dim: int, num_heads: int = 16) -> None:
        super().__init__()
        self.num_heads = num_heads
        self.qkv = nn.Linear(dim, dim * 3, bias=True)
...
QWEN2_5_VL_VISION_ATTENTION_CLASSES = {
    "eager": Qwen3_VLVisionAttention,
    "flash_attention_2": Qwen3_VLVisionFlashAttention2,
    "sdpa": Qwen3_VLVisionSdpaAttention,
}


class Qwen3_VLVisionBlock(nn.Module):
    def __init__(self, config, attn_implementation: str = "sdpa") -> None:
        ...
        self.mlp = Qwen3_VLMLP(config, bias=True)
...
class Qwen3_VisionTransformerPretrainedModel(Qwen3_VLPreTrainedModel):
    ...
    def __init__(self, config, *inputs, **kwargs) -> None:
        ...
        self.blocks = nn.ModuleList(
            [Qwen3_VLVisionBlock(config, config._attn_implementation) for _ in range(config.depth)]
        )
...
class Qwen3_VLRotaryEmbedding(nn.Module):
    def __init__(self, config: Qwen3_VLConfig, device=None):
        super().__init__()
    ...
    def forward(self, x, position_ids):
        ...
        # Core RoPE block. In contrast to other models, Qwen3_VL has different position ids for thw grids
...
class Qwen3_VLAttention(nn.Module):
    """
    Multi-headed attention from 'Attention Is All You Need' paper. Modified to use sliding window attention: Longformer
    and "Generating Long Sequences with Sparse Transformers".
    """

    def __init__(self, config: Qwen3_VLConfig, layer_idx: Optional[int] = None):
        super().__init__()
        self.config = config
...
class Qwen3_VLFlashAttention2(Qwen3_VLAttention):
    """
    Qwen3_VL flash attention module, following Qwen3_VL attention module. This module inherits from `Qwen3_VLAttention`
...
class Qwen3_VLSdpaAttention(Qwen3_VLAttention):
    """
    ...
    def forward(
        ...
        if output_attentions:
            ...
            logger.warning_once(
                "Qwen3_VLModel is using Qwen3_VLSdpaAttention, but `torch.nn.functional.scaled_dot_product_attention` does not support `output_attentions=True`. Falling back to the manual attention implementation, "
...
QWEN2_5_VL_ATTENTION_CLASSES = {
    "eager": Qwen3_VLAttention,
    "flash_attention_2": Qwen3_VLFlashAttention2,
    "sdpa": Qwen3_VLSdpaAttention,
}


class Qwen3_VLDecoderLayer(nn.Module):
...
class Qwen3_VLCausalLMOutputWithPast(ModelOutput):
    """
    Base class for Qwen3_VL causal language model (or autoregressive) outputs.
...
QWEN2_5_VL_INPUTS_DOCSTRING = r"""
    Args:
        ...
        pixel_values (`torch.FloatTensor` of shape `(seq_length, num_channels * image_size * image_size)):
            ...
            [`AutoImageProcessor`]. See [`Qwen3_VLImageProcessor.__call__`] for details. [`Qwen3_VLProcessor`] uses
            [`Qwen3_VLImageProcessor`] for processing images.
        pixel_values_videos (`torch.FloatTensor` of shape `(seq_length, num_channels * temporal_size * image_size * image_size)):
            The tensors corresponding to the input videos. Pixel values can be obtained using
            [`AutoImageProcessor`]. See [`Qwen3_VLImageProcessor.__call__`] for details. [`Qwen3_VLProcessor`] uses
            [`Qwen3_VLImageProcessor`] for processing videos.
...
class Qwen3_VLForConditionalGeneration(Qwen3_VLPreTrainedModel, GenerationMixin):
    _tied_weights_keys = ["lm_head.weight"]
    config_class = Qwen3_VLConfig
    _no_split_modules = ["Qwen2VLDecoderLayer", "Qwen3_VLVisionBlock"]
    ...
    @replace_return_docstrings(output_type=Qwen3_VLCausalLMOutputWithPast, config_class=_CONFIG_FOR_DOC)
    def forward(
        self,
        input_ids: torch.LongTensor = None,
        attention_mask: Optional[torch.Tensor] = None,
        ...
        *args, **kwargs
        ...
        >>> model = Qwen3_VLForConditionalGeneration.from_pretrained("Qwen/Qwen2.5-VL-7B-Instruct")
...
__all__ = ["Qwen3_VLForConditionalGeneration", "Qwen3_VLModel", "Qwen3_VLPreTrainedModel"]