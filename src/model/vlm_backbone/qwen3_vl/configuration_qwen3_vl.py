...
class Qwen3_VLConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers import Qwen3_VLForConditionalGeneration, Qwen3_VLConfig
    ...
    model_type = "qwen3_vl"
    sub_configs = {"vision_config": Qwen3_VLVisionConfig}
    keys_to_ignore_at_inference = ["past_key_values"]
    # Default tensor parallel plan for base model `Qwen3_VL`
    base_model_tp_plan = {
